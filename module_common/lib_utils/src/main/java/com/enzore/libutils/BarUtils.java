...
import com.safframework.utils.AppUtilsKt;
...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (AppUtilsKt.getApplicationContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, AppUtilsKt.getApplicationContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = AppUtilsKt.getApplicationContext().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = AppUtilsKt.getApplicationContext()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        WindowManager wm = (WindowManager) AppUtilsKt.getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return false;
        }
